...
def generate_weighted_data(x1=0,x2=1,y1=0,y2=1,prior=.5):
    ...
    # w1        
    for i in range(int(1000*prior)):
        xpoints1.append(random.uniform(x1,x2))
        ypoints1.append(random.uniform(x1,x2))

    #w2
    for i in range(int(1000*(1-prior))):
        xpoints2.append(random.uniform(y1,y2))
        ypoints2.append(random.uniform(y1,y2))
...
def main():
    ...
    for i in range(iterations):
        ...
        print(j)
        # generate the data
        data1,data2 = generate_weighted_data(0,1,-2+(.5),-1+(.5),j)
        ...
        # set the priors
        model.priors=[j/iterations,1-(j/iterations)]
